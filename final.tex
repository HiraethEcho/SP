...
In Section 6, we give examples to illustrate each method of Sarkisov program.
...
\end{array} \]
Let $ \mathcal{H}'=|\mathcal{O}(1)| $ be the very ample complete linear system on $X'$, then $H\in |\mathcal{O}_{X}(2)|$. Different choices of $\theta$ and  $\epsilon$ gives different decompositions: 
\begin{enumerate}
